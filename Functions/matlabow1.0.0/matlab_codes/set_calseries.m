...
try
    ...
    fprintf('    > ***tip: to modify these parameters, first delete the file: %s \n',ls_calseries_filename)
catch
    breaks = [];
    max_breaks = 4;
    if isfield(po_system_configuration,'MAX_BREAKS')
        max_breaks=po_system_configuration.MAX_BREAKS;
    end
