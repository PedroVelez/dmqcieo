...
if isfield(po_system_configuration,'PLOT_DIAGNOSIS_FORMAT')==0
    po_system_configuration.PLOT_DIAGNOSIS_FORMAT='EPS';
end

if isfield(po_system_configuration,'ANALYSIS_CODE')==0
    po_system_configuration.ANALYSIS_CODE='';
end
...
if(isempty(find(isnan(PRES)==0, 1))==0) % if no data exists, terminate here, no plots will be produced
    ...
    if(isempty(find(isnan(mapped_sal)==0, 1))==0) % if mapping exists, terminate here, no plots will be produced
        ...
        figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'Name','Float locations')
        ...
        for i=1:n
            h=plot(LONG(i),LAT(i),'o','markersize',2);
            set(h,'color',c(i,:));
        end
        for i=1:10:n
        ...
        if strcmp(po_system_configuration.PLOT_DIAGNOSIS_FORMAT,'PDF')
            print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_01_Map','.pdf'));
        else
        ...
        figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'name','Uncalibrated theta-S curves ');
        set(gcf,'defaultaxeslinewidth',2)
        set(gcf,'defaultlinelinewidth',2)
        ...
        ok = [];
        for k=1:length(jj)
            if ~isempty(find(isfinite(SAL(:,jj(k))), 1)) %PVB
                ok = [ok jj(k)];
            end
        end
        jj = ok;
        ...
        c=colormap;
        for i=1:length(jj)
            qq(i) = plot(PTMP(:,jj(i)), SAL(:,jj(i))); hold on
        ...
        set(gcf,'papertype','usletter','paperunits','inches','paperorientation','portrait','paperposition',[.25,.75,8,9.5]);
        print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_02_TS','.pdf'));
        ...
        if(isempty(find(isnan(cal_SAL)==0, 1))==0) % if no cal exists, terminate here, no plot will be produced
            ...
            figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'name','Calibration curve');
            set(gcf,'defaultaxeslinewidth',2)
            set(gcf,'defaultlinelinewidth',2)
            set(gcf,'defaultaxesfontsize',16)
            ...
            print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_03_PcDs','.pdf'));
            save(strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_03_PcDs'),'avg_Soffset')
            ...
            figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'name','Calibrated theta-S curves')
            set(gcf,'defaultaxeslinewidth',2)
            set(gcf,'defaultlinelinewidth',2)
            set(gcf,'defaultaxesfontsize',14)
            ...
            for k=1:length(jj)
                if ~isempty(find(isfinite(SAL(:,jj(k))))) %PVB
                    ok = [ok jj(k)];
                end
            end
            jj = ok;
            ...
            set(gcf,'papertype','usletter','paperunits','inches','paperorientation','portrait','paperposition',[.25,.75,8,9.5]);
            print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_04_TSCorr','.pdf'));
            ...
            figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'name','Salinity anomaly on theta levels')
            set(gcf,'defaultaxeslinewidth',2)
            set(gcf,'defaultlinelinewidth',2)
            set(gcf,'defaultaxesfontsize',16)
            ...
            print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_05_SecSalOnTheta.pdf'));
                ...
                for j=tplot
                    if(tlevels(j)<max(trimPTMP(:,i))&tlevels(j)>min(trimPTMP(:,i)))
                        ...
                        if isempty(find(~isnan(diffTheta)))
                            ...
                            Thetalevel_indexes(j,i) = find(diffTheta==min(diffTheta), 1 );
                        end
                    end
                end
            end
            ...
            %PVB save(strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_03_SALint'),'Sint')
            
            figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'name','Salinity time series on theta levels')
            set(gcf,'defaultaxeslinewidth',2)
            set(gcf,'defaultlinelinewidth',2)
            set(gcf,'defaultaxesfontsize',16)
            ...
            drawnow
            set(gcf,'papertype','usletter','paperunits','inches','paperorientation','portrait','paperposition',[.25,.75,8,9.5]);
            print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_06_SOnTheta.pdf'));
            ...
            figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'name','Salinity anomaly time series')
            set(gcf,'defaultaxeslinewidth',2)
            set(gcf,'defaultlinelinewidth',2)
            set(gcf,'defaultaxesfontsize',16)
            ...
            drawnow
            set(gcf,'papertype','usletter','paperunits','inches','paperorientation','portrait','paperposition',[.25,.5,8,10]);
            print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_07_SecSalOnThetaCor.pdf'));
            ...
            figure;set(gcf,'defaultLegendAutoUpdate','off');set(gcf,'name','Analyse variance plot')
            ...
            print('-dpdf',strcat(po_system_configuration.FLOAT_PLOTS_DIRECTORY,filesep,po_system_configuration.ANALYSIS_CODE,pn_float_name,'_08_AVariance.pdf'));
