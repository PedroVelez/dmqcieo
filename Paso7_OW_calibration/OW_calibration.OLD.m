...
OW_Config.CONFIG_WMO_BOXES='wmo_boxes.mat';
...
for i1=1:length(floats)
    ...
    %EnviaCorreoArgo('pvelezbelchi@gmail.com',sprintf('Float %2d/%02d %s',i1,length(floats)),num2str(floats(i1)))
    if length(floats)>1
        close all
    end
end
